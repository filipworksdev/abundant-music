...
class PropertyInfoProvider {
    ...
    createDefaultBooleanPropertyInfo(propName, caption, defaultValue, shortDescription, longDescription) {
    ...
    createDefaultFloatPropertyInfo(propName, caption, defaultValue, extraConstraints) {
        const constraints = [];
        if (extraConstraints) {
    ...
    createDefaultLikelihoodPropertyInfo(propName, caption, defaultValue) {
        return this.createDefaultFloatPropertyInfo(propName, caption, defaultValue, [new MinPropertyConstraint(0)]);
    }
    createDefaultProbabilityPropertyInfo(propName, caption, defaultValue) {
        return this.createDefaultFloatPropertyInfo(propName, caption, defaultValue, [new RangePropertyConstraint([0, 1])]);
    }
    createDefaultIntPropertyInfo(propName, caption, defaultValue, extraConstraints) {
        const constraints = [];
        if (extraConstraints) {
            addAll(constraints, extraConstraints);
        }
    ...
    createDefaultIndexPropertyInfo(propName, caption, defaultValue) {
        return this.createDefaultIntPropertyInfo(propName, caption, defaultValue, [new MinPropertyConstraint(0)]);
    }
    createDefaultStringPropertyInfo(propName, caption, defaultValue, shortDescription, longDescription) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createDefaultStringSeedPropertyInfo(propName, caption, defaultValue, shortDescription, longDescription) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createStringTextAreaPropertyInfo(propName, caption, defaultValue) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createDefaultMinIntPropertyInfo(propName, caption, defaultValue, minValue) {
    ...
    createDefaultMinMaxIntPropertyInfo(propName, caption, defaultValue, minValue, maxValue) {
        const info = this.createDefaultIntPropertyInfo(propName, caption, defaultValue);
        info.constraints = [
            {
                getMinValue: function () {
    ...
    createDefaultMinFloatPropertyInfo(propName, caption, defaultValue, minValue) {
    ...
    createDefaultMinMaxFloatPropertyInfo(propName, caption, defaultValue, minValue, maxValue) {
        const info = this.createDefaultFloatPropertyInfo(propName, caption, defaultValue);
        info.constraints = [
            {
                getMinValue: function () {
    ...
    createDefaultRangePropertyInfo(propName, caption, defaultValue, dataType, extraConstraints) {
        const constraints = [
            {
    ...
    createDefaultIntRangePropertyInfo(propName, caption, defaultValue, extraConstraints) {
        return this.createDefaultRangePropertyInfo(propName, caption, defaultValue, GuiPropertyDataType.INT_LIST, extraConstraints);
    }
    createDefaultFloatRangePropertyInfo(propName, caption, defaultValue, extraConstraints) {
        return this.createDefaultRangePropertyInfo(propName, caption, defaultValue, GuiPropertyDataType.FLOAT_LIST, extraConstraints);
    }
    createDefaultRangeListPropertyInfo(propName, caption, defaultValue, dataType, extraConstraints) {
        const constraints = [];
        if (extraConstraints) {
            addAll(constraints, extraConstraints);
        }
    ...
    createDefaultIntListPropertyInfo(propName, caption, defaultValue, extraConstraints) {
        const constraints = [];
        if (extraConstraints) {
            addAll(constraints, extraConstraints);
        }
    ...
    createDefaultIndexListPropertyInfo(propName, caption, defaultValue) {
    ...
    createDefaultIntList2DPropertyInfo(propName, caption, defaultValue) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createDefaultFloatList2DPropertyInfo(propName, caption, defaultValue) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createDefaultIntRangeListPropertyInfo(propName, caption, defaultValue) {
    ...
    createDefaultProbabilityListPropertyInfo(propName, caption, defaultValue) {
    ...
    createDefaultLikelihoodListPropertyInfo(propName, caption, defaultValue) {
    ...
    createDefaultFloatListPropertyInfo(propName, caption, defaultValue, extraConstraints) {
        const constraints = [];
        if (extraConstraints) {
            addAll(constraints, extraConstraints);
        }
    ...
    createStrengthPropertyInfo(propName, caption, defaultValue) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createEnumPropertyInfo(propName, caption, defaultValue, enumType) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createEnumListPropertyInfo(propName, caption, defaultValue, enumType) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createProcedureButtonPropertyInfo(caption, funcName, target, args) {
        const info = new GuiPropertyInfo({
    ...
    createUniqueIdPropertyInfo(prefix, uniqueIdInfo) {
        const info = new GuiPropertyInfo({
            propertyName: "id",
    ...
    createPreviewPropertyInfo(componentConstructor) {
    ...
    createIdReferencePropertyInfo(propertyName, caption, uniqueIdInfo) {
        const info = new GuiPropertyInfo({
    ...
    createIdReferenceListPropertyInfo(propertyName, caption, uniqueIdInfo) {
        const info = new GuiPropertyInfo({
            propertyName: propertyName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createIdReferenceNotSelfPropertyInfo(propertyName, caption, uniqueIdInfo) {
    ...
    createObjectPropertyInfo(propertyName, caption, uniqueIdInfo, constructorTexts) {
        const provider = this;
        const info = new GuiPropertyInfo({
            propertyName: propertyName,
            propertyCaption: caption,
    ...
    createSongPartStructureInfoDataSampleListPropertyInfo(propertyName, caption, uidInfo) {
    ...
    createSongPartStructureInfoListPropertyInfo(propertyName, caption, uidInfo) {
        const info = this.createObjectListPropertyInfo(propertyName, caption, uidInfo, [
    ...
    createObjectListInTabPropertyInfo(propertyName, caption, uniqueIdInfo, constructorTexts, group, groupCaption) {
    ...
    getOrCreateUniqueIdInfo(obj, nsPrefix, initPrefix) {
    ...
    getMixableExportPropertyInfos(result) {
        const constraints = [
    ...
    getMidiExportPropertyInfos(result) {
    ...
    getWavExportPropertyInfos(result) {
    ...
    getWavClientExportPropertyInfos(result) {
        this.getMidiExportPropertyInfos(result);
    }
    getDataSamplePropertyInfos(result) {
    ...
    getPlannedHarmonyElementPropertyInfos(result) {
    ...
    getSequenceHarmonyElementPropertyInfos(result) {
        ...
        result.addPropertyInfo(this.createDefaultFloatListPropertyInfo("lengthPattern", "Length pattern", [1.0], [new ArrayMinLengthConstraint(1), new ArrayElementConstraint(new MinPropertyConstraint(0.01))]));
        ...
        result.addPropertyInfo(this.createDefaultFloatListPropertyInfo("beatStrengths", "Beat strengths", [1, 0.8, 0.9, 0.6, 0.3, 0.4, 0.2], [new ArrayMinLengthConstraint(1)]));
        result.addPropertyInfo(this.createDefaultIntListPropertyInfo("tsNumerators", "Beats per measures", [4], [new ArrayMinLengthConstraint(1)]));
    ...
    getGuiPropertyInfos(obj, parentPropertyInfo) {
        ...
        switch (obj._constructorName) {
            ...
            case "SimpleSequenceHarmonyElement":
                ...
                result.addPropertyInfo(this.createDefaultIntListPropertyInfo("chordInversions", "Chord inversions", [0], [
                    new ArrayElementConstraint(new RangePropertyConstraint([0, 3]))
                ]));
